...
my_plot(axs[0][0], "7p",  60, 120, ["Base","Sham","Roc"], "7p-Base-Sham-Roc")
my_plot(axs[0][1], "13p", 60, 180, ["Base","Sham","Roc"], "13p-Base-Sham-Roc")
my_plot(axs[1][0], "19p", 80, 180, ["Base","Sham","Roc"], "19p-Base-Sham-Roc")
my_plot(axs[1][1], "25p", 80, 200, ["Base","Sham","Roc"], "25p-Base-Sham-Roc")
my_plot(axs[2][0], "31p", 80, 220, ["Base","Sham","Roc"], "31p-Base-Sham-Roc")
my_plot(axs[2][1], "37p", 80, 220, ["Base","Sham","Roc"], "37p-Base-Sham-Roc")
...
my_plot(axs[0][1], "13p", 60, 180, ["Zint","ShamZint","RocZint"], "13p-Zint-ShamZint-RocZint")
my_plot(axs[1][0], "19p", 50, 200, ["Zint","ShamZint","RocZint"], "19p-Zint-ShamZint-RocZint")
...
my_plot(axs[0][1], "13p", 60, 250, ["ZintReg","ShamZintReg","RocZintReg"], "7p-ZintReg-ShamZintReg-RocZintReg")
my_plot(axs[1][0], "19p", 50, 280, ["ZintReg","ShamZintReg","RocZintReg"], "7p-ZintReg-ShamZintReg-RocZintReg")
...
my_plot(axs[0][0], "7p",  80, 210, ["ShamZintTempReg","ShamRocZintTempReg"], "7p-ShamZintTempReg-ShamRocZintTempReg")
